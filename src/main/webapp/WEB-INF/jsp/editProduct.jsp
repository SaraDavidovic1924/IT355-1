    ...
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/editProduct"
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="Hatchback" />Hatchback</label>
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="Jeep" />Jeep</label>
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="Sportski" />Sportski</label>
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="Kabriolet" />Kabriolet</label>

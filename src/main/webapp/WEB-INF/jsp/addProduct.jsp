...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Popunjavanjem forme dodaje se nov model:</p>
        </div>
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/addProduct"
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="productCategory" value="Karavan" />Jeep</label>
            </div>
            ...
            <div class="form-group">
                <label for="manufacturer">Proizvodjač: </label>

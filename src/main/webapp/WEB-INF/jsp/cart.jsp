    ...
    <div class="container">
        <section>
            <div class="jumbotron">
                <div class="container">
                    <h2>Korpa</h2>
                    <p>Modeli koji Vam se dopadaju</p>
                </div>
            </div>
        </section>
            ...
            <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <c:forEach var="item" items="${sessionScope.cart}" varStatus="i">
                    <c:set var="s" value="${s + item.product.productPrice * item.qunatity}"></c:set>
                        ...
                        <td><a href="${pageContext.request.contextPath}/product/viewProduct/${item.product.productId}"><img src="${item.product.productImage}" alt="image" style="width:50px"/></a></td>
